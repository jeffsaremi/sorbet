...
load(
    "@com_stripe_ruby_typer//third_party/llvm:llvm.bzl",
    "cmake_var_string",
    "expand_cmake_vars",
    "gentbl",
    "llvm_all_cmake_vars",
...
load(
    "@com_stripe_ruby_typer//third_party/llvm:common.bzl",
    "template_rule",
)
...
cc_library(
    ...
    copts = llvm_copts + ["-Iexternal/llvm/lib/Target/CSKY"],
    deps = [
        ":CSKYInfo",
        ":CodeGen",
        ":Core",
...
# The original CMakeLists.txt in lib/TextAPI mentions the MachO subdirectory
# explicitly, and also an Elf subdirectory that doesn't exist in the includes
cc_library(
    name = "TextAPI",
    srcs = glob([
        "lib/TextAPI/*.c",
    ...
    hdrs = glob([
        ...
        "include/llvm/TextAPI/MachO/*.h",
        "include/llvm/TextAPI/MachO/*.def",
        "include/llvm/TextAPI/MachO/*.inc",
    ]),
    copts = llvm_copts,
    deps = [
        ":BinaryFormat",
